...
class BUTTONS(object):
    ...
    [InlineKeyboardButton("𝐓ᴀɢ-Aʟʟ", callback_data="mplus HELP_TagAll"),
    ...
    InlineKeyboardButton("𝐆ᴀᴍᴇs", callback_data="mplus HELP_Game"),InlineKeyboardButton("𝐓-ɢʀᴀᴘʜ", callback_data="mplus HELP_TG")],
    [InlineKeyboardButton("𝐈ᴍᴘᴏsᴛᴇʀ", callback_data="mplus HELP_Imposter"),
    InlineKeyboardButton("𝐓ʀᴜᴛʜ-ᗪᴀʀᴇ", callback_data="mplus HELP_TD"),InlineKeyboardButton("𝐇ᴀsᴛᴀɢ", callback_data="mplus HELP_HT")], 
